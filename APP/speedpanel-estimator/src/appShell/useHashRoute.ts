...
export type AdminSubPage = "dashboard" | "products" | "priceLists" | "savedFees" | "systems" | "maths" | "documents" | "requests" | "projectReviews" | "users" | "analytics" | "auditLog" | "orders" | "manufacturing" | "companies" | "permissions";
...
const ADMIN_SUBPAGES: AdminSubPage[] = ["products", "priceLists", "savedFees", "systems", "maths", "documents", "requests", "projectReviews", "users", "analytics", "auditLog", "orders", "manufacturing", "companies", "permissions"];
