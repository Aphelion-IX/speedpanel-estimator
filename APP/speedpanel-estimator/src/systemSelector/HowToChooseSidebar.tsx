...
export const HowToChooseSidebar = () => (
  <>
    ...
    <div className={cx.card + " mt-3"}>
      ...
      {/* No destination wired yet, see SystemSelector.tsx's file-level note --
          disabled so it doesn't present as a live link that does nothing. */}
      <button disabled title="The system guide isn't available yet."
        className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 py-2.5 text-sm font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed" style={{ color: BLUE }}>
