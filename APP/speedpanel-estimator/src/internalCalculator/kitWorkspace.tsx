...
const WallJumpRow = ({ label, name, onClick }: { label: string; name: string; onClick: () => void }) => (
  <button onClick={onClick}
    className="w-full rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3.5 py-3 text-left active:scale-95 transition-all hover:border-[color:var(--blue)]">
  ...
  <div className={cx.section}>
    ...
    <div className="border-t border-slate-100 dark:border-slate-800 pt-3">
      ...
      {kit.result.heightMismatch && (
        <p className="mt-2 flex gap-1.5 text-sm leading-relaxed text-amber-700 dark:text-amber-400">
