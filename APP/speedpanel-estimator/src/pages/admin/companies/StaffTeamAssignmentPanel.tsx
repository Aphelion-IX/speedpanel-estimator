// =============================================================================
// Speedpanel Team assignment editor -- admin-only
// =============================================================================
...
// both is_admin()-gated server-side. Single-assignment roles (Project
// Manager, BDM) render as a radio list -- picking someone new automatically
// replaces the prior assignee (admin_set_staff_assignment enforces this via
// the staff_assignments_single_role_idx partial unique index, not just this
// UI). Multi-assignment roles (Internal Sales, Dispatch, Technical Services)
