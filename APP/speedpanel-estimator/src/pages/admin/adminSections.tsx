...
// =============================================================================
// Every section is listed here regardless of whether its table survived the
// calculator-only schema rebuild (see supabase/schema.sql) -- Workflow
// (Requests/Project Reviews/Orders/Delivery Requests/Manufacturing), People
// (Users/Companies/Roles) and Reports (Analytics/Audit Log), plus Price
// Lists within Catalog, all point at deleted tables and will show an empty/
// error state when opened. That's intentional, not a bug: every page stays
// reachable from the dashboard even when it doesn't work, rather than
// silently disappearing (see AdminDashboard.tsx's own header comment).
// =============================================================================
