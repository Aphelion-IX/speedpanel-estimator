...
// calculator-only schema rebuild (see supabase/schema.sql) -- every group
// below (Workflow/People/Reports, plus Price Lists within Catalog) points at
// a deleted table and will show an empty/error state when opened. That's
// intentional: every admin page stays reachable from the dashboard even when
// it doesn't work, rather than silently disappearing (see AdminDashboard.tsx's
// own header comment).
// =============================================================================
