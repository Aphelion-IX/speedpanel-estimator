import { Package, Layers, Calculator, FileText, ClipboardList, FolderCheck, Users, BarChart3, History, Truck, Factory, Building2, ShieldCheck, Tag, Receipt } from "lucide-react";
...
const ADMIN_GROUPS: { heading: string; items: AdminSection[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "savedFees", label: "Saved Fees", description: "Delivery/fee pick-list for quote adjustments.", icon: <Receipt size={16} /> },
